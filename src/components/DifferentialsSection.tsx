          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {differentials.map((differential, index) => (
              <div key={index} className="group">
                <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-white/20 hover:shadow-2xl hover:border-custom-blue/20 transition-all duration-300 transform hover:-translate-y-2">
                  <div className="w-16 h-16 bg-gradient-to-br from-custom-blue/10 to-blue-500/10 rounded-2xl flex items-center justify-center text-custom-blue mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                    {differential.icon}
                  </div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-4 group-hover:text-custom-blue transition-colors duration-300">
                    {differential.title}
                  </h3>

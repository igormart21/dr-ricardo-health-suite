      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            {/* Location Info */}
            <div className="backdrop-blur-luxury bg-gradient-glass border border-white/30 p-8 rounded-3xl shadow-glass hover:shadow-glow-gold transition-all duration-500">

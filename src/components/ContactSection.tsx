            ...
            <div className="animate-fadeInLeft">
              ...
              <div className="mb-8">
                <a 
                  ...
                  className="inline-flex items-center justify-center w-10 h-10 md:w-12 md:h-12 bg-custom-blue text-white rounded-full hover:bg-gradient-to-r hover:from-custom-blue hover:to-blue-600 shadow-lg hover:shadow-custom-blue/25 transition-all duration-300 transform hover:scale-110"
                >

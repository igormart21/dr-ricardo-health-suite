            ...
            <div className="w-full flex flex-col items-center justify-center">
              <div className="relative group">
                ...
                <img
                  ...
                  className="w-56 h-56 sm:w-64 sm:h-64 md:w-80 md:h-80 object-cover rounded-full shadow-2xl mb-4 md:mb-6 relative z-10 group-hover:scale-105 transition-transform duration-300"
                />
              </div>
              <div className="relative bg-white/90 backdrop-blur-sm p-3 sm:p-4 md:p-6 rounded-2xl shadow-xl max-w-xs sm:max-w-sm md:max-w-md border border-white/20">
                ...
                <p className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-700 text-center leading-relaxed italic">
